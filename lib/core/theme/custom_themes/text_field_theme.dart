...
// constraints: const BoxConstraints.expand (height: 14.inputFieldHeight),
  ...
  static TextSelectionThemeData TextSelectionTheme = TextSelectionThemeData(
    cursorColor: AppColors.primaryLight, // Customize the cursor color
    selectionColor: AppColors.primaryLight.withOpacity(0.3), // Customize the selection color
    selectionHandleColor: AppColors.primaryLight, // Customize the selection handle color
  );
